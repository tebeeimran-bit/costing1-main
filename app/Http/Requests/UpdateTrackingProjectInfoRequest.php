...
class UpdateTrackingProjectInfoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'quantity_forecast_enabled' => 'nullable|boolean',
            'quantity_forecast_period_type' => 'nullable|in:year,month',
            'quantity_forecasts' => 'nullable|array|max:1188',
            'quantity_forecasts.*.year_number' => 'required_with:quantity_forecasts|integer|min:1|max:99',
            'quantity_forecasts.*.calendar_year' => 'nullable|integer|min:2000|max:2200',
            'quantity_forecasts.*.month_number' => 'nullable|integer|min:1|max:12',
            'quantity_forecasts.*.quantity' => 'required_with:quantity_forecasts|numeric|min:0',
