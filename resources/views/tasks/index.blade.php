        ...
        @forelse($filteredTasks as $task)
            <article class="task-card priority-{{ $task->priority }}">
                ...
                <div class="task-side">
                    ...
                    <div class="task-completeness level-{{ $task->completeness['level'] }}"><span>Kelengkapan data</span><b>{{ $task->completeness['score'] }}%</b><small>{{ count($task->completeness['missing']) }} item perlu dilengkapi</small></div>
