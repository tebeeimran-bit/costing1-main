            ...
            <div class="costing-resume-preview" aria-label="Costing resume preview">
                <div class="costing-resume-sheet">
                    ...
                    <div class="costing-resume-main">
                        <div class="costing-resume-title">
                            <span>Cost Of Good Manufacturing Resume</span>
                            <button type="button" class="costing-resume-reset" onclick="resetCostingResumeOverrides()">Reset Manual Edit</button>
                        </div>
                        <div class="costing-resume-top">
                            ...
                            <div>
                                ...
                                <div class="costing-resume-labour">
                                    <span>Labour / Process Cost</span>
                                    <span>Rp</span>
                                    <strong id="crLabourCost" data-cr-field="rate.labour_cost">0,00</strong>
                                </div>
                            </div>
                        </div>

                        <div class="costing-resume-table-wrap">
                            <table class="costing-resume-table">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="costingResumeMaterialBody">
                                    <tr><td colspan="5" class="costing-resume-empty">Material belum tersedia.</td></tr>
                                </tbody>
                            </table>
                        </div>

                        <div class="costing-resume-summary">
                            <div class="costing-resume-summary-row band">
                                <span>TOTAL MATERIAL COST</span><span>Rp</span><span class="text-right" id="crTotalMaterialCost" data-cr-field="summary.material_cost">0,00</span><span class="text-right" id="crTotalMaterialPct" data-cr-field="summary.material_pct">0%</span>
                            </div>
                            <div class="costing-resume-summary-row band">
                                <span>PROCESS COST</span><span id="crProcessHour" data-cr-field="summary.process_hour">0 hour</span><span class="text-right" id="crProcessCost" data-cr-field="summary.process_cost">0,00</span><span class="text-right" id="crProcessPct" data-cr-field="summary.process_pct">0%</span>
                            </div>
                            <div class="costing-resume-summary-row band">
                                <span>DEPRESIASI TOOLING COST</span><span>Rp</span><span class="text-right" id="crToolingCost" data-cr-field="summary.tooling_cost">0,00</span><span class="text-right" id="crToolingPct" data-cr-field="summary.tooling_pct">0%</span>
                            </div>
                            <div class="costing-resume-summary-row band">
                                <span>ADMINISTRATION COST</span><span>Rp</span><span class="text-right" id="crAdminCost" data-cr-field="summary.admin_cost">0,00</span><span class="text-right" id="crAdminPct" data-cr-field="summary.admin_pct">0%</span>
                            </div>
                            <div class="costing-resume-summary-row total">
                                <span>COGM</span><span>Rp</span><span class="text-right" id="crCogmTotal" data-cr-field="summary.cogm_total">0,00</span><span class="text-right" id="crCogmPct" data-cr-field="summary.cogm_pct">100%</span>
                            </div>
                        </div>
